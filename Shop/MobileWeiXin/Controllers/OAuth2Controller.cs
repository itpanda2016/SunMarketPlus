...
namespace MobileWeiXin.Controllers
{
    public class OAuth2Controller : Controller
    {
        ...
        //private string appId2 = "wxbdce16edce380783";
        //private string secret2 = "9b37e42205babb2dc12fe9fe6416373e";
        public ActionResult Index() {
            //此页面引导用户点击授权
            ViewData["UrlUserInfo"] = OAuthApi.GetAuthorizeUrl(appId, "http://piedpiper.net.cn/Oauth2/UserInfoCallback", "JeffreySu", OAuthScope.snsapi_userinfo);
            ViewData["UrlBase"] = OAuthApi.GetAuthorizeUrl(appId, "http://piedpiper.net.cn/Oauth2/BaseCallback", "JeffreySu", OAuthScope.snsapi_base);
            return View();
        }
